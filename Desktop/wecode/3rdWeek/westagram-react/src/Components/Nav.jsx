        ...
        <nav className="nav-container">
            <div className="nav-box">
                ...
                <div className="nav-search">
                    ...
                    <div className="searching-inside">
                        <div className="search-img"></div>
                        <label for="searching" className="search-label">검색</label>
                    </div>
                    <div className="searching-close"></div>
                </div>
                <ul className="nav-icons">
                    ...
                    <li className="navicon">
                        <img src="https://ca.slack-edge.com/TH0U6FBTN-U011AUS6L9F-b3b4decf18f3-512"/>
                    </li>
                </ul>
            </div>
        </nav>
